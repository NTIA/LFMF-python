...
def test_get_lib_name_uses_expected_platform_suffix(
    ...
    monkeypatch.setattr("ITS.PropLibTemplate.proplib_loader.platform.system", lambda: system_name)
    monkeypatch.setattr("ITS.PropLibTemplate.proplib_loader.struct.calcsize", lambda _: pointer_size)
...
def test_get_lib_name_rejects_unknown_platform(
    ...
    monkeypatch.setattr("ITS.PropLibTemplate.proplib_loader.platform.system", lambda: "Plan9")
